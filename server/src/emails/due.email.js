export function dueEmail(catName, vaccine) {
  return `
    <div style="max-width:600px;margin:0 auto;font-family:Arial,Helvetica,sans-serif;">
      ...
      <div style="padding:30px;background:white;">
        <h2 style="color:#1F2937;">Due Today: ${vaccine.name}</h2>
        <p style="color:#6B7280;">${catName}'s ${vaccine.name} vaccine is due today.</p>
